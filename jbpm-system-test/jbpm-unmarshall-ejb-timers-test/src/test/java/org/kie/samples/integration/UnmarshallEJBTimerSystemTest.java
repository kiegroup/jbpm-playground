...
public class UnmarshallEJBTimerSystemTest {
    ...
    public void getVariableBeforeRefresh() throws Exception {
...
/*
    ...
    public void completeTaskAfterRefresh() throws Exception {
        ...
        logger.info("Sleeping 6.5s so the refresh time is call off");
        Thread.sleep(1500);
...
*/
    ...
    private Long startProcessInNode1(String processName) {
        Long processInstanceId = processClient1.startProcess(containerId, processName, singletonMap("duration", "PT30S"));
        assertNotNull(processInstanceId);
        return processInstanceId;
    }
    
    private void findVariableInNode2(Long processInstanceId) {
        Object instanceVar = processClient2.getProcessInstanceVariable(containerId, processInstanceId, "duration");

...
public class KieServerContainer extends GenericContainer<KieServerContainer>{
    ...
    public KieServerContainer(String nodeName, Network network, Map<String,String> args) {
      super( new ImageFromDockerfile()
           ...
           .withFileFromClasspath("etc/jbpm-flow-7.59.1-SNAPSHOT.jar", "etc/jbpm-flow-7.59.1-SNAPSHOT.jar")
           //.withFileFromClasspath("etc/jbpm-flow-7.52.0.Final-redhat-00008-RHPAM-3935.jar", "etc/jbpm-flow-7.52.0.Final-redhat-00008-RHPAM-3935.jar")
